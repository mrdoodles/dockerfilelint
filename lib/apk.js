...
var commands = (module.exports = {
  ...
  apkadd_hasvirtual: function (apkaddCommand) {
    return (
      command_parser.command_has_flag(apkaddCommand, "--virtual") ||
      command_parser.command_has_flag(apkaddCommand, "-t")
    );
  },
  ...
  follows_rmapkcache: function (commands, index) {
    return command_parser
      .get_nextcommands(commands, index)
      .some(function (command) {
        ...
        if (
          !command_parser.command_has_flag(command, "-f") &&
